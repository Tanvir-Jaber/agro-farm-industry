                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <!--<input type="hidden"  class="user_pnumber" name="user_pnumber" >-->
                            ...
                            <h4>Bikash Agent Number <strong class="show-number-bkash"></strong></h4>

                            <input type="text" class="form-control" placeholder="Transaction Number" name="transactionId" required>
                        </div>
                ...
                <form action="search_process.php" method="get">
                    <div class="d-flex justify-content-center">
                        <div class="w-50 input-group input-group-sm">
                            <input type="search" placeholder="Search..." name="product_search" class="form-control">
                            <span class="input-group-append">
                    <button type="submit" name="seraching_btn" style="background-color: #89ABE3FF" class="btn btn-flat text-white">Go!</button>
                  </span>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="">
                            <form id="FormData" action="../process/data-process.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-12">
                                            <button type="submit" name="newNotice" style="background: #89ABE3FF;border: #00adc2;color: #ffffff;font-weight: bold" class="newNotice btn btn-block btn-secondary"><i class="fa fa-sign-language mr-2" aria-hidden="true"></i>Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
