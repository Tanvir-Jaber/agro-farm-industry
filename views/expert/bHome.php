    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">List of Sellers</h1>
                    </div>
                </div>
            </div>
        </div>
        <section class="content">
            <input type="hidden" class="user_id" value="<?php echo $Adid?>">
            <input type="hidden" class="user_name" value="<?php echo $Adname?>">
                        ...
                        <div class="">
                            <div class="card-body">
                                <table id="" class="table table-bordered table-striped">
                                    <thead style="background-color: #CCCC99;color:#FCF6F5FF">
                                    <tr>
                                        <th>Name</th>
                                        <th>Address</th>
                                        <th>Phone Number</th>
                                    ...
                                    if ($list){
                                        foreach ($list as $lists){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="background-color: #CCCC99;color:#FCF6F5FF" data-id = "<?php echo $lists->no?>" href="#" class="attrValue show-chat-box-click btn-sm"><i class="fas fa-user-edit"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
