                        ...
                        <div class="card">
                            <div class="card-body">
                                <table id="" class="table table-bordered table-striped table-hover">
                                    ...
                                    <?php
                                    $list = $dbmanipulate->viewBuyersInfo();
                                    if ($list){
                                        foreach ($list as $lists){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-id = "<?php echo $lists->no?>" href="#" class="attrValue show-chat-box-click btn btn-info btn-sm"><i class="fab fa-telegram-plane"></i></a>
                                                </td>
                                            </tr>
                                            <?php
                                        }
