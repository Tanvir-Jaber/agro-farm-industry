...
if ($details){
    $monthyear = $details->date;
    $mont = $details->time;
    $cur = date("Y-m-d");
    $dates = date('Y-m-d', strtotime(" +$mont months", strtotime($monthyear)));
    if($dates <= $cur){
        $dbmanipulate->updateCheckActiveTimeOver($Seemail);
    }
}
if($details){
    $name=$details->name;
    ...
    <aside class="main-sidebar">
        ...
        <div class="sidebar p-2 ">
            <div class="user-panel d-flex pb-2">
                ...
                <div class="info mt-2">
                    <span class=" d-block font-weight-bold text-white"><?php echo $name?></span>
                </div>
            </div>
            <nav class="mt-2">
                <ul class="nav-list-my nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    ?>
                    <li class="nav-item">
                        <a href="sellersHome.php" class="nav-link">
                    ...
                    <li class="nav-item">
                         <a href="expert_list.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="pending_post.php" class="nav-link five">
